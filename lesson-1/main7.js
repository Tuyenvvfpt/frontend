...
console.warn("Kiem tra Array:", Array.isArray({}))
...
console.log(languages.concat(classes));
/* 8. slice: trích xuất element trong array */
console.warn("slice method:...");
console.log(classes.slice(1, 3));
